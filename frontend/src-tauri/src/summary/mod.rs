...
pub use template_commands::{
    ...
    __cmd__api_get_template_full, __cmd__api_is_custom_template, __cmd__api_list_templates,
    __cmd__api_save_custom_template, __cmd__api_validate_template, api_delete_custom_template,
    api_get_template_details, api_get_template_full, api_is_custom_template, api_list_templates,
